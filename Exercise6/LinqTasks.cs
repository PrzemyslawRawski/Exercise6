...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps.GroupBy(emp => emp.Deptno)
                ...
                .Join(Depts,
                    group => group.Key,
                    dept => dept.Deptno,
                    (group, dept) => new { name = dept.Dname.ToUpper(), numOfEmployees = group.Count() });
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Wlasna();
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> Wlasna(this IEnumerable<Emp> employees)
        {
            return employees.Where(emp => employees.Any(sub => sub.Mgr == emp))
